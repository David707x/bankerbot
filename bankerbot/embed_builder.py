...
region_control_embed1.add_field(name=f"    {bank_emoji} Saint Denis Bank", value=f"{robber_grn} Robber Baron", inline=False)
...
region_control_embed1.add_field(name=f"    {trdp_emoji} Lagras Trading Post", value=f"Unowned", inline=False)
region_control_embed1.add_field(name=f"    {hide_emoji} Clemens Point", value=f"{outlaw_red} Outlaw", inline=False)
region_control_embed2 = discord.Embed(title="Region: New Hanover", description="", color=discord.Colour.green())
region_control_embed2.add_field(name=f"    {bank_emoji} Bank of Valentine", value=f"Unowned", inline=False)
region_control_embed2.add_field(name=f"    {rail_emoji} Emerald Station", value=f"Unowned", inline=False)
region_control_embed2.add_field(name=f"    {indu_emoji} Heartland Oil Fields", value=f"Unowned", inline=False)
region_control_embed2.add_field(name=f"    {trdp_emoji} Van Horn Trading Post", value=f"{robber_blue} Robber Baron", inline=False)
...
region_control_embed3.add_field(name=f"    {rail_emoji} Bacchus Station", value=f"{lawman_pink} Lawman", inline=False)
region_control_embed3.add_field(name=f"    {indu_emoji} Jameson Mining & Coal", value=f"{robber_blue} Robber Baron", inline=False)
region_control_embed3.add_field(name=f"    {trdp_emoji} Colter Trading Post", value=f"Unowned", inline=False)
region_control_embed3.add_field(name=f"    {hide_emoji} Ewing Basin", value=f"Unowned", inline=False)
...
region_control_embed4.add_field(name=f"    {rail_emoji} Riggs Station", value=f"Unowned", inline=False)
region_control_embed4.add_field(name=f"    {indu_emoji} Hobb's Taxidermy", value=f"{robber_grn} Robber Baron", inline=False)
region_control_embed4.add_field(name=f"    {trdp_emoji} Manzanita Post", value=f"Unowned", inline=False)
region_control_embed4.add_field(name=f"    {hide_emoji} Chochinay", value=f"Unowned", inline=False)
region_control_embed5 = discord.Embed(title="Region: New Austin", description="", color=discord.Colour.brand_red())
region_control_embed5.add_field(name=f"    {bank_emoji} Bank of Armadillo", value=f"{robber_blue} Robber Baron", inline=False)
region_control_embed5.add_field(name=f"    {rail_emoji} Mercer Rail Station", value=f"Unowned", inline=False)
region_control_embed5.add_field(name=f"    {indu_emoji} MacFarlane's Ranch", value=f"Unowned", inline=False)
